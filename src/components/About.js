...
const About = () => {
  return (
    <section id="about" className="py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-20 flex flex-col md:flex-row items-center justify-around">
        <div className="md:w-1/2 mb-8 md:mb-0 ">
          <h2 className="text-sm font-bold text-blue-500 uppercase">About Me</h2>
          <h3 className="text-4xl font-bold text-gray-900 mt-2">Innovative Solutions, Effective Problem-Solving</h3>
          <p className="mt-4 text-lg text-gray-500">a passionate and motivated software engineer with a BSc in Computer Science from Moi University. My career has been built on a foundation of curiosity and dedication, leading me to excel in both backend and frontend development. I have a proven track record of delivering impactful solutions using technologies.</p>
        </div>
        <div className="md:w-1/2 md:pl-24">
          <h3 className="text-3xl font-bold text-gray-900 -mt-6">Connect With Me</h3>
          <p className="mt-4 text-lg text-gray-500">I'm always open to new opportunities and collaborations. Whether you have a project in mind or just want to connect, feel free to reach out. Let's build something great together.</p>
